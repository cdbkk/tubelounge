...
TV Command Center is a **local, single-user** app with no authentication. It is
...
[Report a vulnerability](https://github.com/cdbkk/tv-command-center/security/advisories/new)
